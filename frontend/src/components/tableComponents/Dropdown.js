...
const Dropdown = (props) => {
	...
	return (
		<div className="dropdown open">
			<a href="#!" onClick={handleClick} className="px-2" id="triggerId1" data-toggle="dropdown" aria-haspopup="true"
			...
			<div className="dropdown-menu" aria-labelledby="triggerId1" style={{display: toggle && "block"}}>
				<a className="dropdown-item" onClick={props.handleEdit} href="#"><i className="fa fa-pencil mr-1"></i> Edit</a>
